...
namespace MPX
{
    ...
    struct MusicLibPrivate
    {
        ...
        struct CollectionColumnsT : public Gtk::TreeModel::ColumnRecord 
        {
            ...
            Gtk::TreeModelColumn<std::string>                           CollectionSort;
        ...
        MusicLibPrivate (MPX::Player & player, MPX::Source::PlaybackSourceMusicLib & mlib, Glib::RefPtr<Gnome::Glade::Xml> xml)
        {
            ...
            m_TreeViewCollections = new CollectionTreeView(m_RefXml, m_Lib, m_Covers, mlib);
        }
    };
}
...
namespace Source
{
    ...
    , m_MainUIManager(ui_manager)
    {
        ...
        m_MainActionGroup->add (RadioAction::create( gr2, "musiclib-show-collections", "Collections"),
                                                sigc::mem_fun( *this, &PlaybackSourceMusicLib::on_view_change ));
