...
#ifndef XSD_USER_TOP_ALBUMS_HXX
#define XSD_USER_TOP_ALBUMS_HXX
...
class topalbums: public ::xml_schema::type
{
  ...
  // user
  // 
  typedef ::xml_schema::ncname user_type;
  ...
  void
  user (::std::auto_ptr< user_type > p);

  // Constructors.
  //
  topalbums (const type_type&,
             const user_type&);
  ...
  ::xsd::cxx::tree::one< user_type > user_;
};
