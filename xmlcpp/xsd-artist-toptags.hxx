...
#ifndef XSD_ARTIST_TOPTAGS_HXX
#define XSD_ARTIST_TOPTAGS_HXX
...
namespace LastFM
{
  ...
  class tag: public ::xml_schema::type
  {
    ...
    // count
    // 
    typedef ::LastFM::count count_type;
  ...
  class count: public ::xsd::cxx::tree::fundamental_base< ::xml_schema::integer, char, ::xml_schema::simple_type >
  {
    public:
    // Constructors.
    //
    count (const ::xml_schema::integer&);
...
namespace LastFM
{
  ...
  ::std::auto_ptr< ::LastFM::toptags >
  toptags_ (const ::xercesc::DOMInputSource& is,
            ::xml_schema::flags f = 0,
            const ::xml_schema::properties& p = ::xml_schema::properties ());
