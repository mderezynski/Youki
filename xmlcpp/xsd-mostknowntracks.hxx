...
#ifndef XSD_MOSTKNOWNTRACKS_HXX
#define XSD_MOSTKNOWNTRACKS_HXX
...
namespace LastFM
{
  class mostknowntracks: public ::xml_schema::type
  {
    public:
    // track
    // 
    typedef ::LastFM::track track_type;
  ...
  class track: public ::xml_schema::type
  {
    ...
    // url
    // 
    typedef ::xml_schema::integer url_type;
...
namespace LastFM
{
  ...
  mostknowntracks_ (const ::std::string& uri,
                    ::xml_schema::flags f = 0,
  ...
  ::std::auto_ptr< ::LastFM::mostknowntracks >
  mostknowntracks_ (const ::xercesc::DOMInputSource& is,
                    ::xml_schema::flags f = 0,
                    const ::xml_schema::properties& p = ::xml_schema::properties ());
