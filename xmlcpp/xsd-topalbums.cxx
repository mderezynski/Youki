...
namespace LastFM
{
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // album
      //
      if (n.name () == "album" && n.namespace_ () == "LastFM")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // large
      //
      if (n.name () == "large" && n.namespace_ () == "LastFM")
      {
      ...
      // medium
      //
      if (n.name () == "medium" && n.namespace_ () == "LastFM")
      {
      ...
      // small
      //
      if (n.name () == "small" && n.namespace_ () == "LastFM")
      {
