...
namespace Bmp
{
  ...
  DialogPlayUri::~DialogPlayUri ()
  {
  }

  DialogPlayUri*
  DialogPlayUri::create ()
  {
    const std::string path = BMP_GLADE_DIR G_DIR_SEPARATOR_S "dialog-play-uri.glade";
  ...
  DialogPlayUri::DialogPlayUri (BaseObjectType                       * obj,
                                Glib::RefPtr<Gnome::Glade::Xml> const& xml)
  : Gtk::Dialog     (obj),
    m_ref_xml       (xml)
  {
    Util::window_set_icon_list (*this, "player");
    dynamic_cast<Gtk::Image *>(m_ref_xml->get_widget("image-add"))->set (Gtk::StockID (BMP_STOCK_LINK), Gtk::ICON_SIZE_SMALL_TOOLBAR);
  }

  int DialogPlayUri::run (Glib::ustring & uri)
  {
