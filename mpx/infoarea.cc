...
namespace MPX
{
        ...
        , m_cover_alpha(0.)
        , m_pressed(false)
        , cover_anim_area_width(82.0)
        , cover_anim_area_height(82.0)
        , cover_anim_area_x0(1.0)
        , cover_anim_area_y0(1.0)
        , cover_anim_area_x1(cover_anim_area_x0 + cover_anim_area_width)
        , cover_anim_area_y1(cover_anim_area_y0 + cover_anim_area_height)
        , cover_anim_initial_pos(3.0 - 82.0)
  ...
  void
          InfoArea::set_metadata( Metadata & metadata, bool first )
          {
                  ...
                  if( metadata.Image )
                  {
                          set_cover (metadata.Image->scale_simple (82, 82, Gdk::INTERP_BILINEAR), first);
                  }
                  else if( first )
                  {
                          clear_cover ();
