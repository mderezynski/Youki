 ...
 * If <link linkend="BmpSpectrum--message">message property</link> is #TRUE it
 * sends analysis results as application message named
 * <classname>&quot;spectrum&quot;</classname> after each interval of time given
 * by the <link linkend="BmpSpectrum--interval">interval property</link>.
 ...
 *   <link linkend="BmpSpectrum--threshold">threshold property.</link>.
 *   </para>
 * </listitem>
 *
...
GST_BOILERPLATE (BmpSpectrum, bmp_spectrum, GstBaseTransform,
...
static void
bmp_spectrum_class_init (BmpSpectrumClass * klass)
{
...
static void
bmp_spectrum_init (BmpSpectrum * spectrum, BmpSpectrumClass * g_class)
{
...
{
  BmpSpectrum *spectrum = BMP_SPECTRUM (object);
...
bmp_spectrum_set_property (GObject * object, guint prop_id,
    const GValue * value, GParamSpec * pspec)
{
  BmpSpectrum *filter = BMP_SPECTRUM (object);
...
{
  BmpSpectrum *filter = BMP_SPECTRUM (trans);
...
static GstMessage *
bmp_spectrum_message_new (BmpSpectrum * spectrum, GstClockTime endtime)
{
  GstStructure *s;
  GValue v = { 0, };
  GValue *l;
...
{
  BmpSpectrum *spectrum = BMP_SPECTRUM (trans);
  guint wanted;
  gint i, j, k;
  gint32 acc;
  gfloat pos, step;
...
GST_PLUGIN_DEFINE_STATIC (GST_VERSION_MAJOR,
    ...
    "bmpx-spectrum",
    "Run an FFT on the audio signal, output spectrum data",
    plugin_init, VERSION, "LGPL", "BMPx", "http://beep-media-player.org")
