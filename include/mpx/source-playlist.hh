...
//  MPX is covered by.
#ifndef MPX_PLAYBACK_SOURCE__PLAYLIST_HH_HH
#define MPX_PLAYBACK_SOURCE__PLAYLIST_HH_HH
#include "config.h"
...
namespace Source
{
        ...
        }; // end class PlaybackSourcePlaylist 
